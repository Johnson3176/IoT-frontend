...
class ThinFilmFresnelMap extends THREE.DataTexture {
    ...
    _fresnelRefl(refractiveIndex1, refractiveIndex2, cos1, cos2, R, phi) {
        ...
        if (refrRatio * refrRatio * sin1Sqr > 1.0) {
            ...
            var r_p = (refractiveIndex2 * cos1 - refractiveIndex1 * cos2) /
                (refractiveIndex2 * cos1 + refractiveIndex1 * cos2);
            var r_s = (refractiveIndex1 * cos1 - refractiveIndex2 * cos2) /
    ...
    _updateData() {
        ...
        var refrRatioSqrBase = (refractiveIndexFilm * refractiveIndexFilm) /
